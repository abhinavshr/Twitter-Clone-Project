                ...
                <div class="card-body">
                    <div class="hstack gap-2 mb-3">
                        ...
                        <div class="overflow-hidden">
                            <a class="h6 mb-0" href="#!">Sargat Man Singh</a>
                            <p class="mb-0 small text-truncate">@Sargat</p>
                        </div>
                    ...
                    <div class="hstack gap-2 mb-3">
                        ...
                        <div class="overflow-hidden">
                            <a class="h6 mb-0" href="#!">Nitesh Shrestha</a>
                            <p class="mb-0 small text-truncate">@Nitesh</p>
                        </div>
                        <a class="btn btn-primary-soft rounded-circle icon-md ms-auto" href="#"><i
                                class="fa-solid fa-plus"> </i></a>
                    </div>
